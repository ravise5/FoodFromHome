...
public class LocationUser extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void saveDeliveryLocation(View view){
            ...
            if(lastKnownLocation!=null)
            {
                ...
                user.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e==null)
                        {
                            Toast.makeText(LocationUser.this, "Delivery Location Confirmed", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            Toast.makeText(LocationUser.this,e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
